/*
  ...
  ---------------------------------------
  This  program is copied from the book
     Numerical Recipes in C
        (2nd Edition)
  at Page. 59.

  Input:  Matrix A (M x N)
  OutPut: Matrix U (M x N)  Matrix W (N x N)  Matrix V (N x N)
  The result U is actually stored in A.

  The task is to decompose A in to U*W*VT (VT is the transposition of V)
        N
    [       ]    [       ]
    [       ]    [       ]   [w1        ]  [        ]
M   [   A   ]  = [   U   ] * [   w2 ... ] *[   VT   ] 
